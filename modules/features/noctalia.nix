{ self, inputs, ...}: {
    ...
    general = {
      ...
      iRadiusRatio = 0.5;
      boxRadiusRatio = 1;
      screenRadiusRatio = 0.8300000000000001;
      animationSpeed = 1;
    ...
    ui = {
      ...
      panelBackgroundOpacity = 0.6900000000000001;
    ...
    wallpaper = {
      ...
      directory = "/home/kenni/Pictures/Wallpapers";
      monitorDirectories = [ ];
